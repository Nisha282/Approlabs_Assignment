  ...
  return (
    <div className="fullcontainer">
      <div className="logincontainer">
        ...
        <div >
          <label id="newuser">New here? Create a new account</label>
        </div>
        ...
        <div className="gitButton">
          <button>
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcThRa_9b4QRCp3A8G6_YdiUbDT-KUztMz0h6XJwqJ3t-rTs6mZTrqTOW6Y3w8t8aR9iCCvMO__VH-8&usqp=CAU&ec=48665701"
              width={30}
            />
            GitHub
          </button>
